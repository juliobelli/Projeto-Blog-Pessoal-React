...
function CardTemas({tema}: CardTemaProps) {
  return (
    <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
      ...
      <div className="flex">
        <Link to={`/editarTema/${tema.id}`} className='w-full text-slate-100 bg-indigo-800 hover:bg-indigo-600 flex items-center justify-center py-2 hover:scale-105 transition-all'>
